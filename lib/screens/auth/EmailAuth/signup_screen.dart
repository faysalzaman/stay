      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            Padding(
              padding: const EdgeInsets.symmetric(horizontal: 20),
              child:  AppText.subHeading("Please enter your details to sign up.",maxline: 2,color: AppColors.onboadingsubtextcolor),
            ),
           ...
           Padding(
               ...
               children: [
                 ...
                 Column(
                   ...
                   children: [
                     ...
                     Row(
                       children: [
                         AppText.normal("By signing up, you’ve agree to our ",maxline: 2,color: AppColors.onboadingsubtextcolor),
                         AppText.normal("terms and",maxline: 2,color: AppColors.bgcolor,underline: true),
                       ],
                     ),
                     Row(
                       children: [
                         AppText.normal("conditions",maxline: 2,color: AppColors.bgcolor,underline: true),
                         AppText.normal(" and ",maxline: 2,color: AppColors.onboadingsubtextcolor),
                         AppText.normal("Privacy Policy",maxline: 2,color: AppColors.bgcolor,underline: true),
            ...
            Padding(
              ...
              child:   Row(
                ...
                children: [
                  AppText.normal("Already have an account? ",fontWeight: FontWeight.bold),
                  GestureDetector(
                    onTap: (){
                      AppNavigator.goToPage(context: context, screen: SigninScreen());
                    },
                    child: AppText.normal("Sign In",fontWeight: FontWeight.bold,underline: true,color: AppColors.bgcolor),
                  ),
